            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/genre/edit_genre" method="POST" enctype="multipart/form-data">
                        <input type="hidden" value="<?= $semuaGenre["id_genre"] ?>" name="id_genre">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="nama_genre" class="form-label">Nama Genre</label>
                                <input type="text" class="form-control <?= isset($errors['nama_genre']) ? 'is-invalid ' : ''; ?>" 
                                id="nama_genre" name="nama_genre" value="<?= isset($errors['nama_genre']) ? old('nama_genre') : 
                                $semuaGenre["nama_genre"] ?>">
